...
namespace DesignPatterns.Builder
{
    ...
    class BuilderDemo
    {
        public void Demo()
        {
            ...
            User user1 = new("John Smith");
            User user2 = new("Jane Doe");

            // Utilisation du patron.
            UserLoanerBuilder builder = new();
            builder.Library = Library.Instance;
            builder.User = user1;
            ILoaner johnLoaner = builder.ToUserLoaner();

            builder.User = user2;
            ILoaner janeLoaner = builder.ToUserLoaner();

            // Emprunt d'un livre.
            ILoan loan = johnLoaner.Loan(book);
